...
export function OverviewPage({ anomalies, historical, modelInfo }: OverviewPageProps) {
  ...
  return (
    <div className="space-y-10">
      ...
      <section aria-labelledby="overview-evidence-heading" className="space-y-8">
        <div className="grid gap-8 border-b border-border pb-9 xl:grid-cols-[1.5fr_1fr]">
        <div><h2 id="overview-evidence-heading" className="max-w-3xl text-3xl font-semibold tracking-[-0.035em] sm:text-4xl">Historical CO₂ evidence, from source to forecast.</h2><p className="mt-4 max-w-2xl text-sm leading-6 text-muted-foreground">This dashboard does not ingest current atmospheric data.</p></div>
